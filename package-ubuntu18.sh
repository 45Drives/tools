...
docker run -u $(id -u):$(id -g) -w /home/deb/build -it -v$(pwd):/home/deb/build -v$(pwd)/dist/ubuntu:/home/deb --rm $PACKAGE_NAME-ubuntu-builder-ubuntu18 dpkg-buildpackage -us -uc -b
res=$?
if [ $res -ne 0 ]; then
