...
mkdir 45drives-tools-1.8.2
cp -r tools/src/fakeroot/etc 45drives-tools-1.8.2/etc
cp -r tools/src/fakeroot/opt 45drives-tools-1.8.2/opt
rm 45drives-tools-1.8.2/opt/tools
tar -zcvf 45drives-tools-1.8.2.tar.gz 45drives-tools-1.8.2/
rm -rf 45drives-tools-1.8.2
mv 45drives-tools-1.8.2.tar.gz rpmbuild/SOURCES/45drives-tools-1.8.2.tar.gz
mv tools/rpm/45drives-tools-1.8.2.spec rpmbuild/SPECS/45drives-tools-1.8.2.spec
rm -rf tools
rm -rf ~/rpmbuild
cd ..
...
rm -rf 45drives-temp
cd ~/rpmbuild
rpmbuild -ba SPECS/45drives-tools-1.8.2.spec
